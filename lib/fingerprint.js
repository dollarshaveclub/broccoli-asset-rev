...
function Fingerprint(inputTree, options) {
  ...
  this.bypassFingerprinting = options.bypassFingerprinting;
...
Fingerprint.prototype.writeAssetMapJs = function (destDir) {
  ...
  var fileName = this.bypassFingerprinting ? 'asset-map.js' : 'asset-map-' + this.hashFn(contents) + '.js';
